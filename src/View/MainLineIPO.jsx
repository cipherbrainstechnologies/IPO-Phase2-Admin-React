...
const MainLineIPO = () => {
  ...
  const { getAllMainLineIpoData, updatedIpo, createIpo, deleteIpo } =
  ...
  useEffect(() => {
    localStorage.setItem("ipoType", "MainlineIPO");
  }, []);
          ...
          <div className="card-header border-0 pt-6">
            ...
            <div className="card-toolbar">
              ...
              >
                ...
                {isOpen ? (
                  <div
                    className="filterCard menu menu-sub menu-sub-dropdown mx-w-300px w-md-325px"
                    data-kt-menu="true"
                  >
